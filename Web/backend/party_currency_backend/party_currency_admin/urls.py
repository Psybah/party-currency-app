...
from .views import get_users, suspend_user, activate_user, delete_user, get_admin_statistics, get_events, get_pending_events, get_user, change_event_status, get_all_successful_transactions, get_event_transaction
...
urlpatterns = [
    ...
    path('get-all-transactions', get_all_successful_transactions, name='get_all_successful_transactions'),
