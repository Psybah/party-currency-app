  ...
  return (
    <section id="features" className="py-10 px-5 md:px-20 bg-softbg">
      <div className="mb-10 text-center">
        <h3 className="text-bluePrimary text-3xl md:text-5xl font-playfair font-bold mb-6 text-center">
          What We Do
        </h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {featuresData.map((feature, index) => (
          <div
            key={index}
            className="bg-lightgray rounded-3xl shadow-md text-center overflow-hidden"
          >
            <div className="p-4">
              <img
                src={feature.img}
                alt={feature.title}
                className=" items-center w-full h-auto object-contain rounded-xl mb-2 border-b border-gray-300"
              />
            </div>
