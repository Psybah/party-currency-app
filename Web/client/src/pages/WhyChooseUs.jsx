...
export default function WhyChooseUs() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: "Your party should look and feel like you. That&apos;s why we let you design your own party notes! Add your photo, choose your colors, pick a font you love and watch your vision come to life. It&apos;s simple, fun, and makes your celebration extra personal and unforgettable.",
